  ...
  const handleVoidConfirm = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/api/vouchers/${voucher.id || voucher._id}`,
        {
          method: "DELETE",
          headers: {
  ...
  return (
    <Box
      sx={{
        ...
        maxWidth: "1200px", // Prevents it from being too wide
        minWidth: { xs: "100%", md: "800px" }, // Ensures a good minimum width
    ...
    >
            ...
            <CardContent>
              ...
              >
                ...
                <Box>
                  ...
                  <Typography variant="body1">{voucher.entries}</Typography>
                </Box>
                <Box>
                  <Typography variant="subtitle2" color="textSecondary">
                    Status
      ...
      <Dialog open={voidDialogOpen} onClose={() => setVoidDialogOpen(false)}>
        ...
        <DialogContent>
          <Typography>
            Are you sure you want to void this sales voucher? This action cannot
            be undone.
          </Typography>
          <Box
          ...
          >
            ...
            <Typography variant="body2">
              Date: {voucher.date || voucher.dated}
            </Typography>
            <Typography variant="body2">
              Description:{" "}
